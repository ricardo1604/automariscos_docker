...
MySQL - 8.0.41 : Database - automariscos
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`automariscos` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
CREATE TABLE `globales` (
  `zonas` int DEFAULT NULL,
  `mesas` int DEFAULT NULL,
  ...
  `inactividad` int DEFAULT NULL,
  `correonoti` varchar(50) DEFAULT NULL,
  `correonoticc` varchar(125) DEFAULT NULL,
  `bloqueo_comanda` int DEFAULT NULL,
  `refrescar_comanda` int DEFAULT NULL,
  `refrescar_bar` int DEFAULT NULL,
  `refrescar_cocina` int DEFAULT NULL,
  `max_orden_bar` int DEFAULT NULL,
  `max_orden_cocina` int DEFAULT NULL,
...
CREATE TABLE `ingredientes` (
  ...
  `cantidad_elegible` int DEFAULT '0',
...
insert  into `ingredientes`(`ingrediente_id`,`ingrediente`,`unidad`,`estado`,`costo`,`cantidad_elegible`) values 
(1,'AZUCAR EN BOLSITAS','UNIDAD','Activo',0.0100,0),
(2,'CUBITOS MAGY','UNIDAD','Activo',0.0300,0),
(3,'VASO DESECHABLE','UNIDAD','Activo',0.0300,0),
(4,'CUCHARA FORRADA','UNIDAD','Activo',0.0400,0),
(5,'CEREZAS','UNIDAD','Activo',0.0500,0),
(6,'MASECA 50 LBS TORTIMASA','UNIDAD','Activo',0.0600,0),
(7,'TORTILLA DE TACOS','UNIDAD','Activo',0.0600,0),
(8,'CAJA DE COSCAFE','UNIDAD','Activo',0.0700,0),
(9,'PAN DE CAJA','UNIDAD','Activo',0.0900,0),
(10,'HUEVOS DE CODORNIZ','UNIDAD','Activo',0.0900,0),
(11,'ALMEJAS ','UNIDAD','Activo',0.1000,0),
(12,'SAL EN BOLSITAS','UNIDAD','Activo',0.1000,0),
(13,'PANCITO PARA COCTEL','UNIDAD','Activo',0.1100,0),
(14,'JAMON FAMILIAR','UNIDAD','Activo',0.1300,0),
(15,'PAN PARA CHORIPAN ','UNIDAD','Activo',0.1300,0),
(16,'RAPIDITAS','UNIDAD','Activo',0.1300,0),
(17,'LIMONES','UNIDAD','Activo',0.1300,0),
(18,'LATA DE PIÑA TROCITOS','UNIDAD','Activo',0.1500,0),
(19,'NARANJAS','UNIDAD','Activo',0.1500,0),
(20,'ALITAS DE POLLO','UNIDAD','Activo',0.1600,0),
(21,'QUESO CRAF','UNIDAD','Activo',0.1600,0),
(22,'HUEVOS DE GALLINA','UNIDAD','Activo',0.1800,0),
(23,'PEPINOS','UNIDAD','Activo',0.2000,0),
(24,'TORTILLA DE BURRO','UNIDAD','Activo',0.2400,0),
(25,'CONCHAS','unidad','Activo',0.2000,0),
(26,'ELOTES','UNIDAD','Activo',0.2500,0),
(27,'LONGANIZA PRECOCIDA PARA BOCA','UNIDAD','Activo',0.2600,0),
(28,'CRISTAL ','UNIDAD','Activo',0.3300,0),
(29,'CHORIZO PLATO// GUACHO','UNIDAD','Activo',0.4000,0),
(30,'SORBETE (BOLITA)','UNIDAD','Activo',0.4000,0),
(31,'PLATANO','UNIDAD','Activo',0.4000,0),
(32,'JAIBA','UNIDAD','Activo',0.4400,0),
(33,'PAN PARA TORTA MEXICANA','UNIDAD','Activo',0.4500,0),
(34,'PAN CHAPATA','UNIDAD','Activo',0.4800,0),
(35,'COSTILLON','UNIDAD','Activo',0.5000,0),
(36,'PESCADO BOCA','UNIDAD','Activo',0.5000,0),
(37,'MANZANAS','UNIDAD','Activo',0.5000,0),
(38,'FRESA','UNIDAD','Activo',0.5500,0),
(39,'UVA','UNIDAD','Activo',0.5500,0),
(40,'FANTA','UNIDAD','Activo',0.5500,0),
(41,'FRESCA','UNIDAD','Activo',0.5500,0),
(42,'COCA COLA','UNIDAD','Activo',0.5500,0),
(43,'SPRITE','UNIDAD','Activo',0.5500,0),
(44,'KINLEY','UNIDAD','Activo',0.5500,0),
(45,'TE DE LIMON ','UNIDAD','Activo',0.5800,0),
(46,'TE DE DURAZNO','UNIDAD','Activo',0.5800,0),
(47,'COSTILLA PARA PIZZA ','UNIDAD','Activo',0.6100,0),
(48,'ESPAGUETTI ROMA','UNIDAD','Activo',0.6500,0),
(49,'PLATILLO DE PESCADO','UNIDAD','Activo',0.6600,0),
(50,'COCO PARA FROZEN','UNIDAD','Activo',0.7500,0),
(51,'SUPREMA VERDE','UNIDAD','Activo',0.8500,0),
(52,'GOLDEN VERDE','UNIDAD','Activo',0.8600,0),
(53,'GOLDEN EXTRA','UNIDAD','Activo',0.8600,0),
(54,'PILSENER ','UNIDAD','Activo',0.8600,0),
(55,'CORONITA','UNIDAD','Activo',0.9900,0),
(56,'MARAÑON CONGELADO (32 ONZ)','UNIDAD','Activo',1.0000,0),
(57,'DULCE DE ATADO','UNIDAD','Activo',1.1000,0),
(58,'CAMARON CON CABEZA GRANDE','UNIDAD','Activo',1.1500,0),
(59,'MICHELOB ULTRA','UNIDAD','Activo',1.3200,0),
(60,'CORONA','UNIDAD','Activo',1.4500,0),
(61,'MODELO','UNIDAD','Activo',1.5300,0),
(62,'STELLA ARTOIS','UNIDAD','Activo',1.5300,0),
(63,'REGIA','UNIDAD','Activo',1.6300,0),
(64,'SALCHICHA','UNIDAD','Activo',1.7500,0),
(65,'CHAOMIN ','UNIDAD','Activo',1.8100,0),
(66,'MANGO CONGELADO  (BOLSA 22 ONZ)','UNIDAD','Activo',2.5000,0),
(67,'PASTA PARA LASAÑA','UNIDAD','Activo',3.2000,0),
(68,'PESCADO CURVINA MEDIANA','UNIDAD','Activo',4.5000,0),
(69,'MARACUYA CONGELADO (32 ONZ.)','UNIDAD','Activo',5.0000,0),
(70,'MAMEY CONGELADO (22 ONZ.)','UNIDAD','Activo',5.0000,0),
(71,'PIÑA','UNIDAD','Activo',5.0000,0),
(72,'PESCADO BOCA COLORADA MEDIANO','UNIDAD','Activo',5.2500,0),
(73,'MARISCADA/ BLANDOS','UNIDAD','Activo',6.0000,0),
(74,'MARISCADA/DUROS','UNIDAD','Activo',1.0300,0),
(75,'BASE PARA MARISCADA','UNIDAD','Activo',0.6500,0),
(76,'FRESCO DE ENSALADA','UNIDAD','Activo',0.0000,0),
(77,'POLLO PARA EL PERSONAL','PORCION','Activo',1.2500,0),
(78,'PUYASO','ONZA','Activo',0.3300,0),
(79,'FILETE DE DORADO','ONZA','Activo',0.3500,0),
(80,'CREMA DE COCO','ONZA','Activo',0.3500,0),
(81,'POLLO ENTERO PARA PLATO','PORCION','Activo',1.6500,0),
(82,'CAMARON PELADO PARA COCTEL','ONZA','Activo',0.4000,0),
(83,'CUAJADA','ORDEN','Activo',0.2500,0),
(84,'PIMIENTA EN GRANO','ONZA','Activo',0.4500,0),
(85,'CHILI CON CARNE','ONZA','Activo',0.1500,0),
(86,'COMINO EN GRANO','ONZA','Activo',0.5000,0),
(87,'POSTA DE NUCA','ONZA','Activo',0.1800,0),
(88,'LOMO ROLLIZO','ONZA','Activo',0.5000,0),
(89,'CALAMAR PARA COCTEL','ONZA','Activo',0.2200,0),
(90,'CARACOL','ONZA','Activo',0.5000,0),
(91,'CARNE DE TACOS DE RES','ONZA','Activo',0.2600,0),
(92,'PALILLO PARA BARBACOA','ONZA','Activo',0.0200,0),
(93,'MANTEQUILLA','ONZA','Activo',0.5000,0),
(94,'HARINA FUERTE PARA PIZZA','ONZA','Activo',0.0400,0),
(95,'GALON DE SALSA NEGRITO ESPESA','ONZA','Activo',0.0400,0),
(96,'TAJIN','ONZA','Activo',0.5600,0),
(97,'JUGO DE PIÑA JUMEX','ONZA','Activo',0.0500,0),
(98,'STOLICHNAYA','ONZA','Activo',0.5800,0),
(99,'JUGO DE TOMATE JUMEX','ONZA','Activo',0.0500,0),
(100,'ARROBA DE SAL DE COCINA','ONZA','Activo',0.0100,0),
(101,'COSTILLA AHUMADA PARA BOCA  2.5 ONZ','ONZA','Activo',0.6100,0),
(102,'CANELA EN RAJA ','ONZA','Activo',0.6300,0),
(103,'PAPAS FRANCESAS ','ONZA','Activo',0.0730,0),
(104,'ABSOLUT','ONZA','Activo',0.8000,0),
(105,'VINAGRE CLARO','ONZA','Activo',0.0200,0),
(106,'VINAGRE AMARILLO ','ONZA','Activo',0.0200,0),
(107,'AZUCAR A GRANEL','ONZA','Activo',0.0300,0),
(108,'HARINA DE ARROZ NELY','ONZA','Activo',0.0500,0),
(109,'BIDON DE ACEITE','ONZA','Activo',0.0500,0),
(110,'GALON DE SALSA INGLESA','ONZA','Activo',0.0300,0),
(111,'MARGARINA PIZZA','ONZA','Activo',0.0500,0),
(112,'GALON DE SALSA PICANTE','ONZA','Activo',0.0500,0),
(113,'MOSTAZA PREPARADA','ONZA','Activo',0.0600,0),
(114,'HARINA DE TRIGO','ONZA','Activo',0.0800,0),
(115,'MANI EN GRANO','ONZA','Activo',0.0800,0),
(116,'ARROZ COCIDO','ONZA','Activo',0.1000,0),
(117,'AJONJOLI','ONZA','Activo',0.1000,0),
(118,'MORRO','ONZA','Activo',0.1000,0),
(119,'ESENCIA DE VAINILLA BLANCA','ONZA','Activo',0.1200,0),
(120,'LECHE EVAPORADA NESTLE','ONZA','Activo',0.1200,0),
(121,'CORAZON DE RES','ONZA','Activo',0.1300,0),
(122,'COSTILLA RIBLET','ONZA','Activo',0.1400,0),
(123,'CEVADA CON LECHE','ONZA','Activo',0.1500,0),
(124,'FRIJOL ROJO DE SEDA','ONZA','Activo',0.1500,0),
(125,'LOMO DE CERDO','ONZA','Activo',0.1700,0),
(126,'CHICHARON PARA PUPUSAS','ONZA','Activo',0.1700,0),
(127,'CALAMAR COCIDO PARA ARROZ ','ONZA','Activo',0.3000,0),
(128,'FROZEN DE FRESA','ONZA','Activo',0.1700,0),
(129,'FROZEN DE TAMARINDO','ONZA','Activo',0.1700,0),
(130,'FROZEN DE MARACUYA','ONZA','Activo',0.1700,0),
(131,'FROZEN DE ARRAYAN','ONZA','Activo',0.1700,0),
(132,'PASTA DE TOMATE NATURAS','ONZA','Activo',0.1700,0),
(133,'SALSA BARBACOA','ONZA','Activo',0.0700,0),
(134,'CARNE MOLIDA','ONZA','Activo',0.1900,0),
(135,'GALON DE SALSA KETCHUP','ONZA','Activo',0.0700,0),
(136,'ACEITUNA NEGRA EN RODAJA','ONZA','Activo',0.1900,0),
(137,'BATER','ONZA','Activo',0.0800,0),
(138,'SOPA MAGUIE','ONZA','Activo',0.2000,0),
(139,'SALSA PARRILLERA','ONZA','Activo',0.0800,0),
(140,'VERSATIER','ONZA','Activo',0.2000,0),
(141,'CONSOME DE CARNE','ONZA','Activo',0.0900,0),
(142,'LEVADURA PARA PAN','ONZA','Activo',0.2100,0),
(143,'EMPANIZADOR','ONZA','Activo',0.0900,0),
(144,'PECHUGA DESHUEZADA','ONZA','Activo',0.2400,0),
(145,'ACEITE VEGETAL','ONZA','Activo',0.0900,0),
(146,'CONEJO','ONZA','Activo',0.2500,0),
(147,'CONSOME DE POLLO','ONZA','Activo',0.1000,0),
(148,'PESCADETAS','ONZA','Activo',0.2500,0),
(149,'QUESO CHEDAR','ONZA','Activo',0.2500,0),
(150,'MAISENA SIMPLE','ONZA','Activo',0.2500,0),
(151,'MANITA DE CINTA','ONZA','Activo',0.2600,0),
(152,'BOTELLA DE CREMA ','ONZA','Activo',0.1100,0),
(153,'MAYONESA    COCTEL','ONZA','Activo',0.1100,0),
(154,'CONSOME DE CAMARON O PARA SOPAS','ONZA','Activo',0.1200,0),
(155,'BOTE DE PEPINILLO','ONZA','Activo',0.1200,0),
(156,'MARGARINA MIRASOL','ONZA','Activo',0.1300,0),
(157,'LIBRA QUESILLO SUPER','ONZA','Activo',0.1700,0),
(158,'NACHOS (3 ONZ.)','ONZA','Activo',0.1800,0),
(159,'MOZARELLA','ONZA','Activo',0.1800,0),
(160,'SALSA DE OSTRAS ','ONZA','Activo',0.1800,0),
(161,'MONTREAL STEAK','ONZA','Activo',0.1900,0),
(162,'LECHE EN POLVO','ONZA','Activo',0.1900,0),
(163,'PEPPERONI','ONZA','Activo',0.2000,0),
(164,'VINO PRESIDENTE','ONZA','Activo',0.2000,0),
(165,'JUGO DE GRANADINA','ONZA','Activo',0.2100,0),
(166,'ADOBO PASTOR','ONZA','Activo',0.2300,0),
(167,'SAZON COMPLETO','ONZA','Activo',0.2600,0),
(168,'PAPRIKA','ONZA','Activo',0.2900,0),
(169,'MANTECA MAZOLA ','ONZA','Activo',0.3200,0),
(170,'ACEITE DE OLIVA EXTRA VIRGEN','ONZA','Activo',0.3300,0),
(171,'CONCENTRADO DE CAMARON O MARISCOS SECOS','ONZA','Activo',0.3500,0),
(172,'BOTELLA BACARDI ORO','BOTELLA','Activo',8.5540,0),
(173,'ZASON DE SOYA PARA MARISCOS','ONZA','Activo',0.3900,0),
(174,'BOTELLA BACARDI CARTA BLANCA','BOTELLA','Activo',8.5540,0),
(175,'CRUTONES','ONZA','Activo',0.4100,0),
(176,'CHACALIN/ PUD PELADO','ONZA','Activo',0.2700,0),
(177,'SALSA PARA PIZZA','ONZA','Activo',0.5100,0),
(178,'QUESO PARMESANO','ONZA','Activo',0.5100,0),
(179,'LECHE DE COCO','ONZA','Activo',0.2700,0),
(180,'TRAGO JARANA REPOSADO','ONZA','Activo',0.6100,0),
(181,'CREMA DE MARISCO MAGGUIE','ONZA','Activo',0.2700,0),
(182,'CAMARON CON CABEZA PEQUEÑA','ONZA','Activo',0.2800,0),
(183,'LATA DE HONGOS','ONZA','Activo',0.2800,0),
(184,'PIMIENTA NEGRA CRAQUEADA','ONZA','Activo',0.7100,0),
(185,'BRANDY SOLERA ','ONZA','Activo',0.7200,0),
(186,'FINDLANDIA ','ONZA','Activo',0.7500,0),
(187,'BALLANTINE´S $26.00','ONZA','Activo',1.0400,0),
(188,'JIMADOR BLANCO $27.00','ONZA','Activo',1.0800,0),
(189,'JIMADOR REPOSADO $28.00','ONZA','Activo',1.1200,0),
(190,'GIN PARA LONG ISLAND ','ONZA','Activo',1.2000,0),
(191,'SOMETHING ESPECIAL $30.95','ONZA','Activo',1.2400,0),
(192,'JACK DANIEL´S $44','ONZA','Activo',1.7600,0),
(193,'CHIVAS REGAL $51.95','ONZA','Activo',2.0000,0),
(194,'CONDIMENTO CAJUN','ONZA','Activo',0.0000,0),
(195,'GLUTAMATO MONOSODICO','ONZA','Activo',0.0000,0),
(196,'SALSA BUFALO','ONZA','Activo',0.1000,0),
(197,'SALSA CHIPOTLE','ONZA','Activo',0.1040,0),
(198,'CHIVAS REGAL $27.50','ONZA','Activo',0.0000,0),
(199,'SOMETHING ESPECIAL $15.95','ONZA','Activo',0.0000,0),
(200,'JACK DANIEL´S $23.75','ONZA','Activo',0.0000,0),
(201,'TRAGO JARANA BLANCO $19.28','ONZA','Activo',0.5840,0),
(202,'SMIRNOF ROJO','MEDIA','Activo',0.0000,0),
(203,'MEDIA DE BOTRAN BLACK','MEDIA','Activo',3.5830,0),
(204,'MEDIA DE BOTRAN RED','MEDIA','Activo',3.0410,0),
(205,'MEDIA DE VENADO LIGTH ','MEDIA','Activo',3.7470,0),
(206,'RON FLOR DE CAÑA 4 AÑOS ','MEDIA','Activo',0.0000,0),
(207,'MEDIA DE JOSE CUERVO ORO $11.60','MEDIA','Activo',9.6690,0),
(208,'CINTA NEGRA $29.75','MEDIA','Activo',0.0000,0),
(209,'MEDIA DE CINTA ROJA ','MEDIA','Activo',15.4570,0),
(210,'MEDIA DE BUCHANNAS ','MEDIA','Activo',25.4150,0),
(211,'J&B ','MEDIA','Activo',0.0000,0),
(212,'HERRADURA REPOSADO','MEDIA','Activo',0.0000,0),
(213,'HERRADURA BLANCO','MEDIA','Activo',0.0000,0),
(214,'GIN BEEFTEAR','MEDIA','Activo',0.0000,0),
(215,'ABSOLUT LITRO','MEDIA','Activo',0.0000,0),
(216,'BOTRAN 12 AÑOS ','MEDIA','Activo',0.0000,0),
(217,'BOTELLA DE TANQUERAY STERLING','BOTELLA','Activo',16.2470,0),
(218,'CIGARROS','MEDIA','Activo',0.0000,0),
(219,'HIERBA BUENA','ONZA','Activo',0.2500,0),
(220,'LIBRA DE QUESO DURA BLANDO','ONZA','Activo',0.2500,0),
(221,'YUCAS','LIBRA','Activo',0.3500,0),
(222,'LECHUGA REPOLLADA','ONZA','Activo',0.0300,0),
(223,'REMOLACHA','LIBRA','Activo',0.5000,0),
(224,'ZANAHORIA','ONZA','Activo',0.0400,0),
(225,'RABANO','ONZA','Activo',0.0400,0),
(226,'EJOTES','LIBRA','Activo',1.0000,0),
(227,'CEBOLLA MORADA','LIBRA','Activo',1.0000,0),
(228,'CEBOLLA BLANCA','ONZA','Activo',0.0600,0),
(229,'JALAPEÑO','ONZA','Activo',0.0620,0),
(230,'REPOLLOS','LIBRA','Activo',1.0000,0),
(231,'WISQUIL','ONZA','Activo',0.0620,0),
(232,'PIPIANES','LIBRA','Activo',1.0000,0),
(233,'PAPA','ONZA','Activo',0.0718,0),
(234,'MORTADELA','LIBRA','Activo',1.4900,0),
(235,'CABEZA DE PESCADO','LIBRA','Activo',1.5000,0),
(236,'CHILE VERDE','ONZA','Activo',0.0930,0),
(237,'FRIJOLES BLANCOS','LIBRA','Activo',1.5000,0),
(238,'DIENTES DE AJO','ONZA','Activo',0.1000,0),
(239,'CHILES DE COLOR','ONZA','Activo',0.1100,0),
(240,'GALLINAS','PORCION','Activo',2.0000,0),
(241,'HUESO CORRIENTE DE RES','LIBRA','Activo',2.0000,0),
(242,'CILANTRO','ONZA','Activo',0.1800,0),
(243,'FRIJOLES FRESCOS PARA PERSONAL','libra','Activo',2.0000,0),
(244,'AGUACATE','ONZA','Activo',0.1500,0),
(245,'COSTILLA TIPICA AHUMADA PARA PLATO','LIBRA','Activo',3.9500,0),
(246,'CARNE PARA GUISAR','LIBRA','Activo',3.9500,0),
(248,'ALETA','LIBRA','Activo',5.3000,0),
(249,'APIO','ONZA','Activo',0.0600,0),
(250,'COSTILLA FRESCA','ONZA','Activo',0.1900,0),
(251,'BOLSA TRANSPARENTE DE 15LB','LIBRA','Activo',0.0000,0),
(252,'TOMATE','ONZA','Activo',0.0400,0),
(253,'CERVEZA MILLER DRAF','UNIDAD','Activo',1.4200,0),
(254,'CERVEZA HEINEKEN','UNIDAD','Activo',1.4120,0),
(255,'CERVEZA SMIRNOF ICE ROJA','UNIDAD','Activo',1.3200,0),
(256,'CERVEZA SMIRNOF ICE MANZANA','UNIDAD','Activo',1.3200,0),
(257,'CERVEZA SMIRNOF ICE CEREZA','UNIDAD','Activo',1.3200,0),
(258,'CERVEZA SMIRNOF ICE GUARANA','UNIDAD','Activo',1.3200,0),
(259,'BOTELLA DE BOTRAN RED ','BOTELLA','Activo',5.4160,0),
(260,'BOTELLA RON FLOR DE CAÑA 4 AÑOS','BOTELLA','Activo',6.9600,0),
(261,'BOTRAN BLACK $8.15','BOTELLA','Activo',0.3300,0),
(262,'VENADO LIGTH $8.25','BOTELLA','Activo',0.3300,0),
(263,'BOTELLA SMIRNOF ROJO','BOTELLA','Activo',11.8740,0),
(264,'TRAGO JOSE CUERVO ORO $17.500','BOTELLA','Activo',0.7950,0),
(265,'BOTELLA 1800 REPOSADO','BOTELLA','Activo',28.9610,0),
(266,'CINTA ROJA $34.95','BOTELLA','Activo',1.4000,0),
(267,'CINTA NEGRA $54.85','BOTELLA','Activo',2.2000,0),
(268,'BOTELLA BUCHANNAS ','BOTELLA','Activo',47.0830,0),
(269,'TEQUILA 1800 AÑEJO ','BOTELLA','Activo',0.0000,0),
(270,'BOTELLA JOSE CUERVO PLATA','BOTELLA','Activo',17.6690,0),
(271,'BOTELLA DON JULIO REPOSADO $','BOTELLA','Activo',65.8090,0),
(272,'TRAGO DE AMARETO $26.587','ONZA','Activo',1.2080,0),
(273,'LICOR DE CAFÉ SONATA','BOTELLA','Activo',0.0000,0),
(275,'TRAGO TRIPLE SEC','ONZA','Activo',0.4180,0),
(276,'BOTELLA DE VINO TINTO','BOTELLA','Activo',5.6020,0),
(277,'SKYY','BOTELLA','Activo',0.0000,0),
(279,'CHIRIMOL','ONZA','Activo',0.2000,0),
(280,'SALSA ROSADA ','ONZA','Activo',0.1400,0),
(281,'TORTILLA ','UNIDAD','Activo',0.1200,0),
(283,'FRIJOL MOLIDO','ONZA','Activo',0.2500,0),
(284,'CURTIDO','ONZA','Activo',0.1000,0),
(285,'SALSA DE TOMATE PARA PUPUSA','ONZA','Activo',0.1500,0),
(286,'CEBOLLA CURTIDA AMARIILA','ONZA','Activo',0.1250,0),
(287,'CEBOLLA CURTIDA MORADA','ONZA','Activo',0.1000,0),
(289,'CHORIZO DE TUZA','UNIDAD','Activo',0.1500,0),
(290,'FONFO DE MARISCOS','UNIDAD','Activo',0.6500,0),
(291,'FONDO DE GALLINA','UNIDAD','Activo',0.3500,0),
(292,'FONDO DE SOPA DE TORTILLA','UNIDAD','Activo',0.2000,0),
(293,'SOPA DE GALLINA KNOR','ONZA','Activo',0.2000,0),
(294,'ENSALADA NATURAL PARA PLATO','UNIDAD','Activo',0.4000,0),
(295,'CEVICHE DE PESCADO','UNIDAD','Activo',0.6550,0),
(296,'PANKO','ONZA','Activo',0.6190,0),
(297,'PASTA DE AJO CON ACEITE','ONZA','Activo',0.1000,0),
(298,'CASAMIEMTO','ONZA','Activo',0.1200,0),
(299,'SALSA TARTARA','ONZA','Activo',0.2000,0),
(300,'CRAWFISH','ONZA','Activo',0.2500,0),
(301,'ELOTE AMARILLO','UNIDAD','Activo',0.3700,0),
(302,'CAMARON CON CASCARA PARA COCTEL','ONZA','Activo',0.3530,0),
(303,'JALAPEÑO ENCURTIDO','ONZA','Activo',0.1000,0),
(304,'CEBOLLA CARAMELIZADA','ORDEN','Activo',0.3000,0),
(305,'SALSA VERDE TAQUERA','ONZA','Activo',0.2000,0),
(306,'SALSA DE AJO','ORDEN','Activo',0.3000,0),
(307,'SALSA SABOR ORIENTAL','UNIDAD','Activo',0.2100,0),
(308,'CHICLOSA PARA AZAFATON','UNIDAD','Activo',0.3700,0),
(309,'AJO PICADO PRICEMARK','ONZA','Activo',0.2200,0),
(310,'CLAVO DE OLOR','ONZA','Activo',3.0000,0),
(311,'CHICHARRONES CON COSTILLA','ONZA','Activo',0.3760,0),
(312,'PIMENTON O PAPRIKA','ONZA','Activo',0.2800,0),
(313,'RELLENENO DE CAMARON PARA PESCADO (4 ONZ)','ORDEN','Activo',1.7500,0),
(314,'PESCADO CURVINA GRANDE','UNIDAD','Activo',5.5000,0),
(315,'PESCADO BOCA COLORADA GRANDE','UNIDAD','Activo',6.7500,0),
(316,'HERSHEY CHOCOLATE','ONZA','Activo',0.5870,0),
(317,'HIELO','ONZA','Activo',0.0100,0),
(318,'MIXER','UNIDAD','Activo',0.5500,0),
(319,'BOTELLA DE JOSE CUERVO ORO','BOTELLA','Activo',17.5000,0),
(320,'TRAGO DE BAILEYS $23.875','ONZA','Activo',1.0850,0),
(321,'TRAGO DE VINO TINTO ','ONZA','Activo',0.2540,0),
(322,'TRAGO DE DON JULIO REPOSADO','ONZA','Activo',2.9910,0),
(323,'TRAGO DE BOTRAN RED','ONZA','Activo',0.2460,0),
(324,'TRAGO DE RON FLOR DE CAÑA 4 AÑOS','ONZA','Activo',0.3160,0),
(325,'TRAGO SMIRNOF ROJO','ONZA','Activo',0.5390,0),
(326,'TRAGO DE 1800 REPOSADO','ONZA','Activo',1.3160,0),
(327,'TRAGO DE BUCHANA','ONZA','Activo',2.1400,0),
(328,'TRAGO DE JOSE CUERVO PLATA','ONZA','Activo',0.8030,0),
(329,'TRAGO DE TANQUERAY STERLING ','UNIDAD','Activo',0.7380,0),
(330,'TRAGO DE BACARDI CARTA BLANCA','ONZA','Activo',0.3880,0),
(331,'TRAGO DE BACARDI ORO','ONZA','Activo',0.3880,0),
(332,'MEDIA DE BACARDI CARTA BLANCA','MEDIA','Activo',5.4570,0),
(333,'MEDIA BACARDI ORO','MEDIA','Activo',5.4570,0),
(334,'MEDIA DE FINDLANDIA','MEDIA','Activo',9.6720,0),
(335,'SODAS','BOTELLA','Activo',1.5000,1),
(336,'COCTELES_2','ONZA','Activo',4.5000,2),
(337,'COCTELES_3','ONZA','Activo',4.4000,3);
...
(22,291,0.5000,0.1750),
(22,240,1.0000,2.0000),
(22,293,0.2500,0.0500),
(22,281,1.0000,0.1200),
(22,279,1.0000,0.2000),
(92,318,2.0000,1.1000),
(92,335,1.0000,1.5000),
(57,17,0.2500,0.0330),
(57,29,1.0000,0.4000),
(57,78,6.0000,1.9800),
(57,83,1.0000,0.2500),
(57,220,0.1000,0.0250),
(57,279,1.0000,0.2000),
(57,281,1.0000,0.1200),
(57,294,1.0000,0.4000),
(57,298,3.0000,0.3600),
(93,336,1.0000,4.5000),
(94,337,1.0000,4.4000);
...
/*Data for the table `ingredientes_sub` */

insert  into `ingredientes_sub`(`id_ingrediente`,`id_sub`) values 
(335,38),
(335,39),
(335,40),
(335,41),
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci MIN_ROWS=1 MAX_ROWS=1;
...
(24,'libre','green',168235310,NULL,'2025-01-23 00:59:56','0',0,0,'0'),
(25,'libre','green',168235242,NULL,'2025-01-23 01:00:57','0',0,0,'0'),
(27,'libre','green',318215670,NULL,'2024-11-24 18:43:56','0',0,0,'0'),
(33,'libre','green',318215670,NULL,'2024-11-24 18:43:56','0',0,0,'0'),
(40,'libre','green',168235310,NULL,'2025-01-23 00:59:56','0',0,0,'0'),
(45,'libre','green',318215678,NULL,'2024-11-24 18:38:56','0',0,0,'0'),
(69,'libre','green',318215678,NULL,'2024-11-24 18:38:56','0',0,0,'0');
...
CREATE TABLE `ordenes_lineas` (
  ...
  `ORDEN_CORRELATIVO` bigint DEFAULT NULL,
...
(22,'COMBO DE GALLINA',7.5000,7.2110,'SOPAS','SOPAS Y CREMAS','1/2 SOPA ACOMPAÑADA DE 1/4 DE GALLINA ','Activo','2024-05-11','SOPA.jpg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-11 15:39:02'),
(23,'SOPA DE TORTILLA',4.5000,2.1010,'SOPAS','SOPAS Y CREMAS','SOPA DE TORTILLA CON AGUACATE QUESO Y CREMA','Activo','2024-05-11','SOPA_TORTILLA.jpeg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-11 15:46:53'),
(24,'CONCHAS GRATINADAS',7.0000,6.0190,'PLATOS','PABOTANEAR','CONCHAS GRATINADAS','Activo','2024-05-11','CONCHAS_GARTINA.jpeg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-11 16:27:51'),
(25,'PLATO DE PESCADETA',6.5000,6.4480,'PLATOS','PABOTANEAR','ACOMPAÑADO DE CHIMOL Y CEBOLLA CURTIDA','Activo','2024-05-11','PESCADETA.jpeg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-11 16:32:36'),
(26,'PLATILLO DE PESCADO',5.6000,5.5940,'PLATOS','PABOTANEAR','ACOMPAÑADO DE LIMON Y TORTILLA FRITA','Activo','2024-05-11','PESCADO.jpg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-11 16:39:20'),
(27,'CHORICERO TIPICO',5.5000,3.8950,'PLATOS','PABOTANEAR','ACOMPAÑADO DE AGUACATE Y TORTILLA Y CUAJADA','Activo','2024-05-11','CHORICERO.jpeg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-11 19:52:04'),
(28,'PLATO DE BOCAS CARNIVORO',17.2500,17.0390,'PLATOS','PABOTANEAR','ACOMPAÑADO DE PAPAS TORTILLA Y SUS SALSAS','Activo','2024-05-11','CARNIVORO.jpeg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-11 20:01:32'),
(29,'PLATO DE BOCAS MIXTO',17.2500,15.6960,'PLATOS','PABOTANEAR','ACOMPAÑADO DE PAPAS SALSAS Y TORTILLA FRITA','Activo','2024-05-11','MIXTO.jpeg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-11 21:28:21'),
(30,'PLATO DE BOCAS DEL MAR',17.2500,14.5170,'PLATOS','PABOTANEAR','ACOMPAÑADO DE PAPAS TORTILLA Y SALSAS','Activo','2024-05-11','BOCAS_DEL_MAR.jpeg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-11 21:40:21'),
(31,'PLATILLO DE CAMARONES EMPANIZADOS',9.0000,6.3560,'PLATOS','PABOTANEAR','ACOMPAÑADOS DE SALSA TARTARA Y TORTILLA','Activo','2024-05-23','PLATILLO_CAMARONES_EMPA.jpeg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-11 21:58:32'),
(32,'PLATILLO DE CAMARONES AL AJILLO',8.5000,6.7180,'PLATOS','PABOTANEAR','ACOMPAÑADOS DE AGUACATE, TORTILLA FRITA.','Activo','2024-05-23','PLATILLO_CAMARONES_AL_AJILLO.jpeg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-11 22:19:10'),
(33,'PLATO DE COSTILLON',6.5000,6.2790,'PLATOS','PABOTANEAR','5 COSTILLON, ACOMPAÑADO, TORTILLA Y CHIMOL','Activo','2024-05-11','COSTILLON.jpeg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-11 22:32:45'),
(34,'TROCITOS DE LONJA EMPANIZADA',8.0000,7.9000,'PLATOS','PABOTANEAR','ACOMPAÑADOS DE SALSA TARTARA Y TORTILLA FRITA.','Activo','2024-05-11','TROCITOS_DE_LONJA.jpeg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-11 22:44:41'),
(35,'CAMARONES SALTEADOS AL CAJUN',15.2500,15.1960,'PLATOS','PABOTANEAR','1 LB. CAMARONES AL ESTILO LOUISIANA.','Activo','2024-05-17','CAMARONES_CAJUN.jpeg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-12 00:01:36'),
(36,'ENSALADA NATURAL',3.5000,2.2480,'ENTRADAS','ENSALADAS','ENSALADA FRESCA','Activo','2024-05-12','ENSALADA_NATU.jpg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-12 00:58:24'),
(37,'ENSALADA CESAR',7.8500,7.8470,'PLATOS','ENSALADAS','ENSALADA CESAR','Activo','2024-05-12','ENSALADD_CESAR.jpg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-12 01:15:15'),
(38,'CLUB SANDWICH DE POLLO',6.0000,5.8290,'ENTRADAS','SANDWICH','SANDWICH ACOMPAÑADO DE PAPAS ','Activo','2024-05-17','SANDWICH.jpeg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-17 21:42:15'),
(39,'CLUB SANDWICH MIXTO',5.5000,3.4210,'ENTRADAS','SANDWICH','ACOMPAÑADO DE PAPAS FRANCESAS','Activo','2024-05-17','SANDWICH.jpeg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-17 21:51:02'),
(40,'PEPITO DE RES',8.0000,7.9390,'ENTRADAS','SANDWICH','ACOMPAÑADO DE PAPAS FRANCESAS','Activo','2024-05-17','PEPITO.jpeg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-17 22:08:55'),
(41,'PEPITO DE PECHUGA',6.0000,5.8050,'ENTRADAS','SANDWICH','ACOMPAÑADO DE PAPAS FRANCESAS','Activo','2024-05-17','PEPITO.jpeg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-17 22:21:29'),
(42,'TACOS DE CERDO ADOBADO',6.5000,6.1940,'ENTRADAS','LO MEXICANO','4 TACOS DE CERDO ADOBADO','Activo','2024-05-17','TACOS__CERDO.jpeg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-17 22:42:51'),
(43,'TACOS DE RES ',6.7500,6.6980,'ENTRADAS','LO MEXICANO','4 TACOS DE RES','Activo','2024-05-17','TACOS__CERDO.jpeg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-17 22:45:23'),
(44,'TORTA MEXICANA DE RES',7.5000,7.3570,'ENTRADAS','LO MEXICANO','ACOMPAÑADA DE CHIMOL Y SALSA','Activo','2024-05-17','TORTA_MEXICANA.jpeg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-17 22:57:15'),
(45,'TOREADITO DE RES ',6.0000,5.7160,'ENTRADAS','LO MEXICANO','FAJITAS PICANTES ACOMPAÑADOS DE TORTILLA FRITA','Activo','2024-05-17','TOREADO.jpeg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-17 23:04:59'),
(46,'TOREADITO MIXTO',6.5000,6.2850,'ENTRADAS','LO MEXICANO','FAJITAS PICANTES CON TORTILLA FRITA','Activo','2024-05-17','TOREADO.jpeg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-17 23:13:46'),
(47,'BURRITO DE RES O CERDO',7.5000,7.2820,'ENTRADAS','LO MEXICANO','ACOMPAÑADO DE SU SALSA','Activo','2024-05-17','BURRITO.jpeg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'true','RES/CERDO','RES/CERDO','2024-05-17 23:23:16'),
(48,'ARROZ CON CAMARONES',7.2500,7.1170,'PLATOS','ARROCES','ACOMPAÑADO DE TORTILLA FRITA','Activo','2024-05-18','ARROZ_CAMARO.jpeg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-18 00:33:00'),
(49,'ARROZ CON CALAMARES',6.7500,6.6940,'PLATOS','ARROCES','ACOMPAÑADO DE TORTILLA FRITA','Activo','2024-05-18','ARROZ_CON_CALAMR.jpeg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-18 00:40:44'),
(50,'ARROZ CON CONCHAS',7.7500,7.7370,'PLATOS','ARROCES','ACOMPAÑADO DE TORTILLA FRITA','Activo','2024-05-18','ARROZ_CON_CONCHAS.jpeg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-18 00:51:10'),
(51,'PINCHO DE RES ',8.7500,8.6240,'PLATOS','PINCHOS','ACOMPAÑADO DE DOS TORTILLAS','Activo','2024-05-18','PINCHO_DE_RES.jpeg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-18 22:28:55'),
(52,'PINCHO DE PECHUGA',6.5000,6.4290,'PLATOS','PINCHOS','ACOMPAÑADO DE DOS TORTILLA ','Activo','2024-05-18','PINCHO_DE_POLLO.jpeg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-18 22:50:11'),
(53,'PINCHO DE CERDO',6.0000,5.5350,'PLATOS','PINCHOS','ACOMPAÑADO DE DOS TORTILLAS','Activo','2024-05-18','PINCHO_DE_CERDO.jpeg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-18 23:14:19'),
(54,'COSTILLA RIBLET',6.7500,5.5730,'PLATOS','CARNES Y POLLOS','ACOMPAÑADO DE TORTILLA Y CEBOLLA Y SALSA','Activo','2024-05-18','COSTILLA_RIBLET.jpeg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-18 23:30:16'),
(55,'PLATO DE PECHUGA DESHUEZADA',7.0000,6.1670,'PLATOS','CARNES Y POLLOS','ACOMPAÑADOS DE PAPAS AL AJO','Activo','2024-05-19','PECHUGA.jpeg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-18 23:34:53'),
(56,'PLATO DE POLLO ENCEBOLLADO',6.0000,5.6040,'PLATOS','CARNES Y POLLOS','ACOMPAÑADO DE ARROZ Y TORTILLA','Activo','2024-05-18','POLLO_ENCEBOLLADO.jpeg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-18 23:42:13'),
(57,'PLATO PUYAZO ',8.5000,7.6640,'PLATOS','CARNES Y POLLOS','ACOMPAÑADO DE UNA TORTILLA Y ENSALADA','Activo','2024-10-13','PUYAZO.jpeg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'true','Que termino?/Que acompañamiento?','TERMINO MEDIO/TERMINO BIEN COCIDO/TERMINO TRES CUARTOS,PAPAS/CEBOLLA','2024-05-18 23:57:04'),
(58,'LOMO DE CERDO ADOBADO',6.5000,4.8670,'PLATOS','CARNES Y POLLOS','CERDO ADOBADO ACOMPAÑADO DE PAPAS Y TORTILLA','Activo','2024-05-19','PECHUGA.jpeg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-19 00:00:08'),
(59,'COSTILLA TIPICA AHUMADA',11.3000,11.2180,'PLATOS','CARNES Y POLLOS','ACOMPAÑADA DE SUS SALSAS','Activo','2024-05-19','TIPICA_AHUMADA.jpeg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-19 00:08:32'),
(60,'PLATO TIPICO',11.7500,11.7300,'PLATOS','CARNES Y POLLOS','ACOMPAÑADO DE UNA TORTILLA GUACAMOLE Y CUAJADA','Activo','2024-05-23','TIPICO.jpeg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'true','TERMINO MEDIO/TERMINO TRES CUARTO/TERMINO BIEN COCIDO','TERMINO MEDIO/TERMINO TRES CUARTO/TERMINO BIEN COCID','2024-05-23 14:14:56'),
(61,'LONJA A PLANCHA',9.0000,8.4040,'PLATOS','NUESTRAS ESPECIALIDADES','ACOMPAÑADA DE TORTILLA FRITA','Activo','2024-05-23','LONJA_A_LA_PLANCHA.jpeg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'true','AL AJO/A LA PLANCHA','AL AJO/A LA PLANCHA','2024-05-23 18:06:09'),
(62,'LONJA EMPANIZADA',9.3500,8.6970,'PLATOS','NUESTRAS ESPECIALIDADES','ACOMPAÑADA DE PAPAS Y SALSA TARTARA','Activo','2024-05-23','LONJA_EMPANIZADA.jpeg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-23 18:17:05'),
(63,'PLATO DE CAMARONES EMPANIZADOS',13.5000,12.4340,'PLATOS','NUESTRAS ESPECIALIDADES','ACOMPAÑADO DE PAPAS Y SALSA','Activo','2024-05-23','PLATO_DE_CAMARONES_EM.jpeg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-23 18:35:57'),
(64,'PLATO DE CAMARONES A LA PLANCHA',12.5000,12.4070,'PLATOS','NUESTRAS ESPECIALIDADES','ACOMPAÑADO DE PAPAS Y TORTILLA','Activo','2024-05-23','PLATO_A_LA_PLANCHA.jpeg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-23 19:05:56'),
(65,'PLATO MIXTO',16.5000,16.4000,'PLATOS','NUESTRAS ESPECIALIDADES','ACOMPAÑADOS DE PAPA Y UNA TORTILLA','Activo','2024-05-23','PLATO_MIXTO.jpeg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'true','TERMINO MEDIO/TERMINO TRES CUARTOS/TERMINO BIEN COCIDO','TERMINO MEDIO/TERMINO TRES CUARTOS/TERMINO BIEN COCIDO','2024-05-23 19:20:09'),
(66,'PLATO MAR TIERRA Y AIRE',19.0000,18.9830,'PLATOS','NUESTRAS ESPECIALIDADES','ACOMPAÑADO DE PAPAS Y UNA TORTILLA','Activo','2024-05-23','PLATO_MAR_Y_TIERRA.jpeg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-23 19:24:24'),
(67,'PARRILLADA MARINERA',31.5000,31.4250,'PLATOS','NUESTRAS ESPECIALIDADES','ACOMPAÑADA DE TORTILLA Y PAPAS AL AJO','Activo','2024-05-23','PARRILLADA_MARINERA.jpeg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'true','TERMINO MEDIO/TERMINO TRES CUARTOS/TERMINO BIEN COCIDO','TERMINO MEDIO/TERMINO TRES CUARTOS/TERMINO BIEN COCIDO','2024-05-23 19:30:31'),
(68,'COSTILLA SABOR ORIENTAL',8.5000,8.3660,'PLATOS','CARNES Y POLLOS','ACOMPAÑADA DE ARROZ Y ENSALADA','Activo','2024-05-24','COSTILLA_SABOR_ORIENTAL.jpeg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-24 14:30:40'),
(69,'AZAFATON AUTOMARISCOS',26.0000,25.9950,'PLATOS','NUESTRAS ESPECIALIDADES','ACOMPAÑADO DE PAPAS Y DOS CHICLOSAS','Activo','2024-05-24','AZAFATON.jpeg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-24 14:52:14'),
(70,'PLATO DE CHICHARRONES CON COSTILLA',13.5000,13.3150,'PLATOS','CARNES Y POLLOS','ACOMPAÑADO DE CEBOLLA Y TORTILLA FRITA','Activo','2024-05-30','CHICHARRONES.jpeg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-25 22:26:30'),
(71,'PLATO DE CURVINA RELLENA MEDIANA',14.5000,14.1460,'PLATOS','NUESTRAS ESPECIALIDADES','ACOMPAÑADO DE ENSALADA Y TORTILLA FRITA','Activo','2024-05-25','CURBVINBA.jpeg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-25 23:04:57'),
(72,'PLATO DE CURVINA RELLENA GRANDE',17.0000,16.1800,'PLATOS','NUESTRAS ESPECIALIDADES','ACOMPAÑADO DE TORTILLA FRITA Y ENSALADA','Activo','2024-05-25','CURBVINBA.jpeg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-25 23:10:19'),
(73,'BOCA COLORADA RELLENA MEDIANA',16.0000,15.6720,'PLATOS','NUESTRAS ESPECIALIDADES','ACOMPAÑADO DE ENSALADA Y TORTILLA FRITA','Activo','2024-05-25','CURBVINBA.jpeg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-25 23:21:45'),
(74,'BOCA COLORADA RELLENA GRANDE',19.0000,18.7230,'PLATOS','NUESTRAS ESPECIALIDADES','ACOMPAÑADO DE TORTILLA FRITA Y ENSALADA','Activo','2024-05-25','CURBVINBA.jpeg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-25 23:25:06'),
(75,'PLATO DE ALITAS ',7.5000,5.0420,'PLATOS','NUESTRAS ESPECIALIDADES','ACOMPAÑADO DE BASTONES DE APIO Y ZANAHORIA','Activo','2024-05-26','ALAS.jpg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'true','BUFALO/BARBACOA/CHIPOTLE','BUFALO/BARBACOA/CHIPOTLE','2024-05-26 00:49:14'),
(76,'COPA DE SORBETE',3.2500,3.1400,'BEBIDAS','BEBIDAS FRIAS Y CALIENTES','TRES BOLITAS DE SORBETE ','Activo','2024-05-30','COPA_SORBTE.jpeg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-30 13:40:05'),
(77,'LIMONADA CON SODA',2.0000,1.6480,'BEBIDAS','BEBIDAS FRIAS Y CALIENTES','LIMONADA CON SODA','Activo','2024-05-30','LIMONADA_NAT.jpg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-30 13:51:05'),
(78,'LIMONADA CON HIERBABUENA',2.0000,0.6570,'BEBIDAS','BEBIDAS FRIAS Y CALIENTES','LIMONADA CO N HIERBA BUENA','Activo','2024-05-30','LIMONADA_NAT.jpg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-30 13:59:21'),
(79,'LIMONADA NATURAL',1.5000,0.5290,'BEBIDAS','BEBIDAS FRIAS Y CALIENTES','LIMONADA NATURAL','Activo','2024-05-30','LIMONADA_NAT.jpg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-30 14:01:07'),
(80,'JUGO DE NARANJA NATURAL',2.0000,1.8310,'BEBIDAS','BEBIDAS FRIAS Y CALIENTES','JUGO DE NARANJA','Activo','2024-05-30','JUGO_NARANJA.jpg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-30 14:03:25'),
(81,'CEVADA CON LECHE',2.0000,0.8440,'BEBIDAS','BEBIDAS FRIAS Y CALIENTES','CEVADA CON LECHE','Activo','2024-05-30','CEVADA.jpg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-30 14:08:51'),
(82,'BOTELLA CON AGUA',1.1500,0.7830,'BEBIDAS','BEBIDAS FRIAS Y CALIENTES','BOTELLA CON AGUA','Activo','2024-05-30','AGUA.png',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-30 14:11:36'),
(83,'TE HELADO DE LIMON',1.5000,1.2920,'BEBIDAS','BEBIDAS FRIAS Y CALIENTES','TE HELADO DE LIMON','Activo','2024-05-30','TE_HELADO.jpg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-30 14:13:18'),
(84,'TE HELADO DE DURAZNO',1.5000,1.2920,'BEBIDAS','BEBIDAS FRIAS Y CALIENTES','TE HELADO DE DURAZNO','Activo','2024-05-30','TE_HELADO.jpg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-30 14:34:36'),
(85,'COCA COLA',1.5000,1.2310,'BEBIDAS','BEBIDAS FRIAS Y CALIENTES','COCA COLA','Activo','2024-05-30','COCA_COLA.jpg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-30 14:51:22'),
(86,'FANTA',1.5000,1.2310,'BEBIDAS','BEBIDAS FRIAS Y CALIENTES','FANTA','Activo','2024-05-30','FANTA.jpg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-30 14:55:15'),
(87,'UVA TROPICAL',1.5000,1.2310,'BEBIDAS','BEBIDAS FRIAS Y CALIENTES','UVA','Activo','2024-05-30','UVA.jpg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-30 14:57:41'),
(88,'FRESA TROPICAL',1.5000,1.2310,'BEBIDAS','BEBIDAS FRIAS Y CALIENTES','FRESA','Activo','2024-05-30','FRESA.jpg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-30 14:59:26'),
(89,'KINLEY',1.5000,1.2310,'BEBIDAS','BEBIDAS FRIAS Y CALIENTES','KINLEY','Activo','2024-05-30','KINLEY.jpg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-30 15:02:28'),
(90,'FRESCA',1.5000,1.2310,'BEBIDAS','BEBIDAS FRIAS Y CALIENTES','FRESCA LATA','Activo','2024-05-30','FRESCA.jpg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-30 15:04:49'),
(91,'SPRITE',1.5000,1.2310,'BEBIDAS','BEBIDAS FRIAS Y CALIENTES','SPRITE','Activo','2024-05-31','SPRITE.png',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-31 20:38:37'),
(92,'BOTELLA DE ABSOLUT',44.0000,41.9920,'LICOR','BOTELLAS DE WHISKEY','ORDEN DE HIELO LIMON Y DOS SODAS','Activo','2024-09-27','ABSOLUT.jpg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-05-31 20:50:38'),
(93,'COCTEL EJEMPLO 2 TIPOS',10.5000,9.1530,'COCKTEL','COCKTELES Y CEVICHES','PRUEBA','Activo','2024-10-17','COCTELCAMA.jpg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-10-17 10:08:25'),
(94,'COCTEL EJEMPLO 3 TIPOS',11.5000,8.9500,'COCKTEL','COCKTELES Y CEVICHES','EJEMPLO 3 ','Activo','2024-10-17','COCTELCAMA.jpg',NULL,NULL,NULL,NULL,'true','true','true','true','true','true','true','true','true',50.0000,20.0000,'false','','','2024-10-17 10:09:55');
...
CREATE TABLE `roles` (
  `grupo_id` int NOT NULL COMMENT 'grupo',
  `opcion_id` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Tabla de construccion de menu principal';
...
insert  into `subproductos_asignados`(`producto_id`,`subproducto_id`,`cantidad`) values 
(92,82,1.0000),
(92,85,1.0000),
(92,86,1.0000),
(92,87,1.0000),
...
(47,'MESEROS','MESEROS','b521caa6e1db82e5a01c924a419870cb72b81635','ACTIVO','MESERO',0,1.00,1.00,'2023-02-23 06:11:30','azul','true','true','true','true','true','true','true','true','true','true','2023-04-09 15:18:12'),
...
/* Function  structure for function  `get_ifsubingrediente` */

/*!50003 DROP FUNCTION IF EXISTS `get_ifsubingrediente` */;
DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `get_ifsubingrediente`(p_producto_id INT) RETURNS int
    DETERMINISTIC
BEGIN
    DECLARE result INT DEFAULT 0;
    -- Check if producto_id exists in ingredientes_asignados and corresponding ingrediente_id exists in ingredientes_sub
    IF EXISTS (
        SELECT 1
        FROM ingredientes_asignados ia
        JOIN ingredientes_sub isub
        ON ia.ingrediente_id = isub.id_ingrediente
        WHERE ia.producto_id = p_producto_id
    ) THEN
        SET result = 1; -- Set result to 1 (TRUE) if found
    END IF;
    RETURN result; -- Return 1 (TRUE) or 0 (FALSE)
END */$$
DELIMITER ;
