...
function get_estructura($mapa)
{
  ...
  { 
    ...
    {     
      ...
      //$tablezone1 .= '<tr><td><img title="mesero : ' . $row['MESERO'] . '" id="mesa_' . $row['MESA'] . '" onclick="seleccionar_mesa(' . $row['MESA'] . ',0)" src="images/' . $imageurl . '"  width="' . $w . 'px" height="' . $h . 'px" style="margin:0 auto;"><span id="smesa_' . $row['MESA'] . '" onclick="seleccionar_mesa(' . $row['MESA'] . ',0)" style="font-size:' . $ft . ';position:relative;top: ' . $t . 'px;left: ' . $l . 'px;">' . $row['MESA'] . '</span></td></tr><tr><td>&nbsp</td></tr>';
      $tablezone1 .= '<tr style="width:20px"><td><img title="mesero : ' . $row['MESERO'] . '" id="mesa_' . $row['MESA'] . '" onclick="seleccionar_mesa(' . $row['MESA'] . ',0)" src="images/' . $imageurl . '"  width="' . $w . 'px" height="' . $h . 'px" style="margin:0 auto;"><span id="smesa_' . $row['MESA'] . '" onclick="seleccionar_mesa(' . $row['MESA'] . ',0)" style="font-size:' . $ft . ';position:relative;top: ' . $t . 'px;left: ' . $l . 'px;">' . $row['MESA'] . '<label style="font-size: 8px;color: white;">' . $mesa_padre . '</label></span></td></tr><tr><td>&nbsp</td></tr>';
    ...
    if ($row['ZONA'] == '2')
    {
      ...
      $tablezone2 .= '<tr><td><img title="mesero : ' . $row['MESERO'] . '" id="mesa_' . $row['MESA'] . '" onclick="seleccionar_mesa(' . $row['MESA'] . ',0)" src="images/' . $imageurl . '"  width="' . $w . 'px" height="' . $h . 'px" style="margin:0 auto;"><span id="smesa_' . $row['MESA'] . '" onclick="seleccionar_mesa(' . $row['MESA'] . ',0)" style="font-size:' . $ft . ';position:relative;top: ' . $t . 'px;left: ' . $l . 'px;">' . $row['MESA'] . '<label style="font-size: 8px;color: white;">' . $mesa_padre . '</span></td></tr><tr><td>&nbsp</td></tr>';
    ...
    if ($row['ZONA'] == '3')
    {
      ...
      $tablezone3 .= '<tr><td><img title="mesero : ' . $row['MESERO'] . '" id="mesa_' . $row['MESA'] . '" onclick="seleccionar_mesa(' . $row['MESA'] . ',0)" src="images/' . $imageurl . '"  width="' . $w . 'px" height="' . $h . 'px" style="margin:0 auto;"><span id="smesa_' . $row['MESA'] . '" onclick="seleccionar_mesa(' . $row['MESA'] . ',0)" style="font-size:' . $ft . ';position:relative;top: ' . $t . 'px;left: ' . $l . 'px;">' . $row['MESA'] . '<label style="font-size: 8px;color: white;">' . $mesa_padre . '</span></td></tr><tr><td>&nbsp</td></tr>';
    ...
    if ($row['ZONA'] == '4')
    {
      ...
      $tablezone4 .= '<tr><td><img title="mesero : ' . $row['MESERO'] . '" id="mesa_' . $row['MESA'] . '" onclick="seleccionar_mesa(' . $row['MESA'] . ',0)" src="images/' . $imageurl . '"  width="' . $w . 'px" height="' . $h . 'px" style="margin:0 auto;"><span id="smesa_' . $row['MESA'] . '" onclick="seleccionar_mesa(' . $row['MESA'] . ',0)" style="font-size:' . $ft . ';position:relative;top: ' . $t . 'px;left: ' . $l . 'px;">' . $row['MESA'] . '<label style="font-size: 8px;color: white;">' . $mesa_padre . '</span></td></tr><tr><td>&nbsp</td></tr>';
    ...
    if ($row['ZONA'] == '5')
    {
      ...
      $tablezone5 .= '<tr><td><img title="mesero : ' . $row['MESERO'] . '" id="mesa_' . $row['MESA'] . '" onclick="seleccionar_mesa(' . $row['MESA'] . ',0)" src="images/' . $imageurl . '"  width="' . $w . 'px" height="' . $h . 'px" style="margin:0 auto;"><span id="smesa_' . $row['MESA'] . '" onclick="seleccionar_mesa(' . $row['MESA'] . ',0)" style="font-size:' . $ft . ';position:relative;top: ' . $t . 'px;left: ' . $l . 'px;">' . $row['MESA'] . '<label style="font-size: 8px;color: white;">' . $mesa_padre . '</span></td></tr><tr><td>&nbsp</td></tr>';
    ...
    if ($row['ZONA'] == '6')
    {
      ...
      $tablezone6 .= '<tr><td><img title="mesero : ' . $row['MESERO'] . '" id="mesa_' . $row['MESA'] . '" onclick="seleccionar_mesa(' . $row['MESA'] . ',0)" src="images/' . $imageurl . '"  width="' . $w . 'px" height="' . $h . 'px" style="margin:0 auto;"><span id="smesa_' . $row['MESA'] . '" onclick="seleccionar_mesa(' . $row['MESA'] . ',0)" style="font-size:' . $ft . ';position:relative;top: ' . $t . 'px;left: ' . $l . 'px;">' . $row['MESA'] . '<label style="font-size: 8px;color: white;">' . $mesa_padre . '</span></td></tr><tr><td>&nbsp</td></tr>';
    ...
    if ($row['ZONA'] == '7')
    {
      ...
      $tablezone7 .= '<tr><td><img title="mesero : ' . $row['MESERO'] . '" id="mesa_' . $row['MESA'] . '" onclick="seleccionar_mesa(' . $row['MESA'] . ',0)" src="images/' . $imageurl . '"  width="' . $w . 'px" height="' . $h . 'px" style="margin:0 auto;"><span id="smesa_' . $row['MESA'] . '" onclick="seleccionar_mesa(' . $row['MESA'] . ',0)" style="font-size:' . $ft . ';position:relative;top: ' . $t . 'px;left: ' . $l . 'px;">' . $row['MESA'] . '<label style="font-size: 8px;color: white;">' . $mesa_padre . '</span></td></tr><tr><td>&nbsp</td></tr>';
    ...
    if ($row['ZONA'] == '8')
    {
      ...
      $tablezone8 .= '<tr><td><img title="mesero : ' . $row['MESERO'] . '" id="mesa_' . $row['MESA'] . '" onclick="seleccionar_mesa(' . $row['MESA'] . ',0)" src="images/' . $imageurl . '"  width="' . $w . 'px" height="' . $h . 'px" style="margin:0 auto;"><span id="smesa_' . $row['MESA'] . '" onclick="seleccionar_mesa(' . $row['MESA'] . ',0)" style="font-size:' . $ft . ';position:relative;top: ' . $t . 'px;left: ' . $l . 'px;">' . $row['MESA'] . '<label style="font-size: 8px;color: white;">' . $mesa_padre . '</span></td></tr><tr><td>&nbsp</td></tr>';
    ...
    if ($row['ZONA'] == '9')
    {
      ...
      $tablezone9 .= '<tr><td><img title="mesero : ' . $row['MESERO'] . '" id="mesa_' . $row['MESA'] . '" onclick="seleccionar_mesa(' . $row['MESA'] . ',0)" src="images/' . $imageurl . '"  width="' . $w . 'px" height="' . $h . 'px" style="margin:0 auto;"><span id="smesa_' . $row['MESA'] . '" onclick="seleccionar_mesa(' . $row['MESA'] . ',0)" style="font-size:' . $ft . ';position:relative;top: ' . $t . 'px;left: ' . $l . 'px;">' . $row['MESA'] . '<label style="font-size: 8px;color: white;">' . $mesa_padre . '</span></td></tr><tr><td>&nbsp</td></tr>';
    ...
    if ($row['ZONA'] == '10')
    {
      ...
      $tablezone10 .= '<tr><td><img title="mesero : ' . $row['MESERO'] . '" id="mesa_' . $row['MESA'] . '" onclick="seleccionar_mesa(' . $row['MESA'] . ',0)" src="images/' . $imageurl . '"  width="' . $w . 'px" height="' . $h . 'px" style="margin:0 auto;"><span id="smesa_' . $row['MESA'] . '" onclick="seleccionar_mesa(' . $row['MESA'] . ',0)" style="font-size:' . $ft . ';position:relative;top: ' . $t . 'px;left: ' . $l . 'px;">' . $row['MESA'] . '<label style="font-size: 8px;color: white;">' . $mesa_padre . '</span></td></tr><tr><td>&nbsp</td></tr>';
...
function get_detalles_sum()
{
  ...
  $dat = $info->get_vista_detallada_sum();
...
{ 
  ...
  $ret .= '<tr ' . $clase . '><td ><img src="images/mesa' . $c . '.png" height ="20px" width="20px" /></td><td>' . $row['ESTADO'] . '</td><td>' . $row['COUNT'] . '</td><td>' . $row['POR'] . '</td></tr>';
}
...
if ($estado == 'tab_principal_comanda') 
{
 ...
 // }
  ...
  echo '<div style="width: 100%;border-style: double;background-color:' . $bgc  .';">  
   ...
   Mesero : <input type="text" id="meseroact2" readonly style="width:100px"/></b>&nbsp
   <button onClick="actualizar_colores_prompt()" style="width:45px;height:35px;background-color:lightblue;" id="abrircomanda"><img id="abrircomanda" src="images/mesav.png" height ="30px" width="30px" title="Mesas" /></button>
   </div>
   <div id="" style="flex:1.60;border-radius: 6px;border: 1px solid black;background-color:' . $bgc  .';" >
   <center>
  ...
  <div style="height:560px;width: 100%;display:flex;border-style: double;background-color:' . $bgc  .';"> <div style="overflow-y:scroll;">' . $categorias . '</div>
  <div id="submenus" style="overflow:auto;flex:0.75;border-radius: 6px;border: 1px solid black;background-color:teal;" >
  </div>
  <div id="listadoorden" style="overflow:auto;flex:1.25;border-radius: 6px;border: 1px solid black;background-color:teal;" >
  <div>
  <input type="text" id="cliente" placeholder="Nombre" size="10px"/>
  <button type="button" class="btn btn-primary btn-sm" onClick="agregar_subcuenta()">+ Cuentas...</button>
  ...
  <div id="mesacuentas" style="overflow:auto;border-style: double;">
  ...
  <td><button type="button" style="height:25px;background-color: lightgreen;font-size: 10px;" class="rounded-circle" id="cuentaprincipal" onClick="seleccionar_cuenta_principal(this.id)">Principal</button></td>
   ...
   <div id="mesadetalles" style="height:450px;background-repeat: no-repeat;background-size: 100% 100%;background-image: ' . $url . ';">
   <br><br>
   ...
   <button onClick="enviar_calcuto()"> ENVIAR </button>
     ...
     <div id="myModalsubingre" style="display: none; /* Hidden by default */
   position: fixed; /* Stay in place */
   /*left: 70%;
   top: 30%;*/
   left: 50%;
   ...
   "> 
   <center>
   <input type=text id="ingreactual" disabled hidden/>
   <div id="listadosubingredientes">
   
   </div>

    <button onClick="procesar_subingrediente()"> ACEPTAR </button>
    <button onClick="esconder_modalsubingre()"> CANCELAR </button>
    </center> 
   </div>
 ...
 <div class="receipt-items" id="contenidoprecuenta">
  ...
  <div class="receipt-total" id="precuentat">  
   ...
   <div id="comanda" style="overflow:auto;object-position: 50% 50%;width:85.5%;height:320px;margin-left: 9.5%;color: black;font-size:12px">
   </div>
  ...
  <br></div><div id="transcurrido"><span id="tiempobloqueos" hidden>' . $mesabloqueo[0] . '</span><b>TRANSCURRIDO </b><span id="elapsedtime"></span>:<span id="elapsedtimes"></span></div> 
  ...
  <div style="text-align: center;background-color:gray"><h5>COMANDA - SELECCION DE MESAS :</h5> </div>
  ...
  <center><label style="color:white"> B A R </label></center>
  </div> &nbsp
  <div id=""  style="overflow:auto;height:25px;flex:1.20;border-radius: 6px;border: 1px solid black;background: rgb(72,72,73); background: linear-gradient(186deg, rgba(72,72,73,1) 1%, rgba(77,144,152,1) 56%);">
  <center>&nbsp<button disabled style="background-color:red;width:20px;height:20px"></button>&nbspOCUPADA&nbsp<button disabled style="background-color:yellow;width:20px;height:20px"></button>&nbspORDENANDO&nbsp&nbsp<button style="background-color:green;width:20px;height:20px" disabled></button>&nbspLIBRE</center>
  </div> &nbsp
  <div id=""  style="height:25px;flex:0.5;border-radius: 6px;border: 1px solid black;background: rgb(72,72,73); background: linear-gradient(186deg, rgba(72,72,73,1) 1%, rgba(77,144,152,1) 56%);">
  <center><button onclick="mostrar_vistadetallada()">Vista Detallada <img src="images/detalle.png" height ="20px" width="20px" /></button></center>
  </div>
  <div id="" style="height:25px;width:10px;border-radius: 6px;border: 1px solid black;background-color:lightgreen;visibility: hidden;">
  </div> 
  </div>
  ...
  <div id="area1"  style="overflow:auto;height:270px;flex:1.5;border-radius: 6px;border: 1px solid black;background:rgb(147, 198, 231);" >
  ' . $area1 . '
  </div> &nbsp
  <div id="area2"  style="overflow:auto;height:270px;flex:1.20;border-radius: 6px;border: 1px solid black;background:rgb(147, 198, 231);">
  ' . $area2 . '
  </div> &nbsp
  <div id="area3"  style="overflow:auto;height:270px;flex:0.5;border-radius: 6px;border: 1px solid black;background:rgb(147, 198, 231);">
  ' . $area3 . '
  </div>
  <div id="" style="height:270px;width:10px;border-radius: 6px;border: 1px solid black;background-color:lightgreen;visibility: hidden;">
  </div> 
  ...
  <div style="display:flex;">
     &nbsp&nbsp
     <div id="area4"  style="overflow:auto;height:270px;flex:1.52;border-radius: 6px;border: 1px solid black;background:rgb(147, 198, 231);" >
     ' . $area4 . '
     </div>  &nbsp
    <div id="infopanel" style="overflow:auto;height:270px;flex:1.71;border-radius: 6px;border: 1px solid black;background:rgb(147, 198, 231);">
    <br>
    &nbsp<button type="button" class="bg-info" style="width:100px"> <img src="images/mesero.png" height ="50px" width="50px" onClick="mostrar_modalmeseros()"/>MESERO ACTUAL</button>
    &nbsp<button type="button" class="bg-primary" style="width:100px" onclick="seleccionar_llevar()"> <img src="images/llevar.png" height ="50px" width="50px" />PARA LLEVAR</button>
    &nbsp<button type="button" class="bg-info" style="width:100px"> <img src="images/cambio.png" height ="50px" width="50px" />CAMBIO DE MESA</button>
    ' . $liberar . '
    <br><br>&nbsp<img src="images/autologo.jpg" height ="40px" width="40px" />&nbsp<img src="images/login.png" id="logcom" height ="40px" width="40px" onClick="logout_comanda()"/><br>
    ...
    <tr><td>Mesero :</td><td><input type="text" id="meseroact" readonly style="width:120px; background: none; border: none; outline: none; font-weight: bold;"/></td></tr>
    </table>
    </div>  &nbsp
  ...
  <div id=""  style="background-color:black;height:25px;flex:1.5;border-radius: 6px;border: 1px solid white;" >
  <center><label style="color:white"> E S C E N A R I O </label></center>
  </div> &nbsp
  ...
  <center><b>SELECCIONE UN MESERO :</b>  <br>
  ' . $meseros . ' <br>
  <input type="number" pattern="[0-9]*" id="usermeseropassxx" inputmode="numeric" style="-webkit-text-security:disc;width:340px" onkeypress="seleccionar_usuario(event)" hidden>
  <input type="text"  id="usermeseropass"  style="-webkit-text-security:disc;width:340px" onkeypress="seleccionar_usuario(event)"><br>Presione Enter<br>
  ...
  <center>
  <div id="vdetalladasum"  style="height:155px;border-radius: 6px;border: 1px solid black;background:rgb(147, 198, 231);" >
  ' . $detallessum . '
  </div> 
  <b>VISTA DETALLADA :</b> <img src="images/detalle.png" height ="40px" width="40px" /> <br>
  <div id="vdetallada"  style="overflow:auto;height:340px;border-radius: 6px;border: 1px solid black;background:rgb(147, 198, 231);" >
   ' . $detalles . '
   </div> 
   </center> 
  </div>
...
function botones_decomanda($usuario)
{
  ...
  vertical-align: middle;
  height:35px;width:85px;font-weight:bold;font-size:10px" 
  class="btn btn-outline-dark btn-sm border border-dark" onClick="enviar_comanda()">ENVIAR</button> 

  <button id="unirmesas" 
  style="background-image: url(images/merge2.png); 
  background-repeat: no-repeat; 
  background-position: 0px 0px;  
  border: none;          
  cursor: pointer;   
  ...
  vertical-align: middle;
  height:35px;width:85px;font-weight:bold;font-size:10px" 
  class="btn btn-outline-dark btn-sm border border-dark" onClick="unir_mesas()">UNIR MESAS</button> 

  <button id="dividircuentas" 
  style="background-image: url(images/split.png); 
  background-repeat: no-repeat; 
  background-position: 0px 0px;  
  border: none;          
  cursor: pointer;   
  ...
  vertical-align: middle;
  height:35px;width:85px;font-weight:bold;font-size:10px" 
  class="btn btn-outline-dark btn-sm border border-dark" onClick="dividir_cuentas()" >DIVIDIR CUENTAS</button> 
  ...
  class="btn btn-outline-dark btn-sm border border-dark" onClick="ver_precuenta()" >PRECUENTA</button> 
  ...
  vertical-align: middle;
  height:35px;width:95px;font-weight:bold;font-size:10px" 
  class="btn btn-outline-dark btn-sm border border-dark" onClick="ver_modificar()" >MODIFICAR</button> 
...
if ($estado == 'refresh_vistadetallada')
{
  $info = new crud();
...
if ($estado == 'tab_prodsselec') 
{
  ...
  if ($ver == 1) 
  {
    ...
    {  
       ...
       $ret .= '<button type="button" class="bg-info" style="font-size:12px;width: fit-content;height:130px" ' . $servir . '> <img src="images/productos/' . $row['URLIMG'] . '"  height ="110px" width="120px" id="prods_' . $row['PRODUCTO_ID'] . '" title="' . $row['NOMBRE_PROD'] . '" data-preguntas="' . $preguntas . '" data-respuestas="' . $row['RESPUESTAS'] . '"  data-nombre="' . $row['NOMBRE_PROD'] . '" data-precio="' . $row['PRECIO_FINAL'] . '" data-propina="' . $row['PROPINA'] . '"  data-subingre="' . $row['SUBINGRE'] . '" onClick="' . $funcion . '"/><br><span > <b>' . $row['NOMBRE_PROD'] . '</b></span> </button>';
    }
...
{ 
  ...
  {   
     $catasig .=  '<tr><td> ' . $row['NOMBRE'] . '</td><td><input  type="button" value="Φ" class="bg-primary" id="lupa_'. $row['CAT_ID'] . '"  onClick="mostrar_imagenprod(this.id)" >&nbsp<input  type="button" value=">>" class="bg-danger" id="bscat_'. $row['CAT_ID'] . '"  onClick="quitar_scattocat(this.id)" ></td></tr>';
  }
  $catasig .= '</table>';
  ...
  {  
    ...
    else
    {
     ...
     $catasig2 .=  '<tr><td> ' . $row['NOMBRE'] . '</td><td><input  type="button" value="Φ" class="bg-primary" id="lupa_'. $row['CAT_ID'] . '"  onClick="mostrar_imagenprod(this.id)" >&nbsp<input  type="button" value="<<" class="bg-success" id="ascat_'. $row['CAT_ID'] . '"   onClick="asignar_scattocat(this.id)" ></td><td class="bg-' . $color . '">'. $row['ESTADO'] . '</td></tr>';
  }
  $catasig2 .= '</table>';
...
if ($estado == 'tab_productoscontenidos') {
  ...
  // ASIGNADOS
  $result_menu = $info->convertid_tomenu($idfinal);

  $result_j = $info->get_prods_seleccion($result_menu[0]);

  // Adding a div with vertical scrolling
  $ret .= '<div style="max-height: 200px; overflow-y: auto;">';
  $ret .= '<ul style="text-align: left;">';

  foreach ($result_j as $row) {  
      $ret .= '<li><strong>' . $row['NOMBRE_PROD'] . '</strong></li>';
  }
...
if ($estado == 'tab_subingreseleccionar') {
  $id = $_POST['id'];
  ...
  // ASIGNADOS
  $result_j = $info->get_ingredientesmandatorios($id);

  // Adding a div with vertical scrolling
  $ret .= '<div style="max-height: 200px; overflow-y: auto;">';
  $ret .= '<form id="ingredientesForm" style="text-align: left;">';  // Added text-align for left justification

  foreach ($result_j as $row) {
    $cantidad = $row['CANTIDAD_ELEGIBLE'];
    //var_dump($cantidad);
  }

  foreach ($result_j as $row) {
      // Generate a checkbox for each ingredient and justify to the left
      $ret .= '<div style="display: inline-block; text-align: left; width: 100%;">';
      $ret .= '<input type="checkbox" name="ingredientes[]" value="' . htmlspecialchars($row['INGREDIENTE']) . '" style="margin-right: 5px;" /> ';
      $ret .= '<b>' . htmlspecialchars($row['INGREDIENTE']) . '</b>';
      $ret .= '</div><br>';  // Line break for each checkbox
  }

  $ret .= '</form>';  // Close form tag
  $ret .= '</div> <input type=number id="ingreactualtexto" value ="' . $cantidad . '"  disabled hidden/><br>';

  $ret2 .= 'Seleccione ' . $cantidad . ' productos. <br>' . $ret;
...
if ($estado == 'enviar_comanda')
{
  ...
  foreach ($listado_comanda as $value) {
      $guardar_orden = $info->enviar_comanda($num_personas,$mesa,$value,$ordenm,$ordend,$ordena,$orden,$ordenzeros,$ordenmasked,$usuarioc,$usuario,$propina);
  }
...
if ($estado == 'modificar_comanda')
{
  ...
  // guardar las lineas basado en los datos de la orden para linkear
     ...
     foreach ($listado_comandaextras as $value) {
        $guardar_orden = $info->enviar_comanda($num_personas,$mesa,$value,$ordenm,$ordend,$ordena,$ordensola,$ordensub,$orden,$usuarioc,$usuario,$propina);
    }
